...
MIR_SOCKET=${socket} XDG_SESSION_TYPE=mir GDK_BACKEND=wayland QT_QPA_PLATFORM=${qt_qpa_platform} SDL_VIDEODRIVER=wayland WAYLAND_DISPLAY=${wayland_display} dbus-run-session -- ${launcher}
